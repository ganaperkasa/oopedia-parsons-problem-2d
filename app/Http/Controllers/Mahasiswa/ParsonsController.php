...
class ParsonsController extends Controller
{
    ...
    ->when($difficulty === 'parsons', function ($query) {
        ...
        return $query->where('difficulty', 'parsons')
    ...
    ->get();
        ...
        return view('mahasiswa.materials.questions.parsons-problem.levels', compact('material', 'materials', 'questions', 'difficulty', 'isGuest'));
    }
...
public function getQuestionData(Material $material, $questionId)
{
    ...
    public function submitParsons(Request $request, $materialId)
    {
         ...
         * =========================
         */
        $attempt = Progress::where('user_id', $userId)
        ...
        return response()->json([
            ...
            'explanation' => $isCorrect
                ? 'Susunan kode sudah benar.'
                : 'Urutan kode masih salah, silakan coba lagi.'
        ]);
    }
    ...
    public function submitDragDrop(Request $request, $materialId)
    {
         ...
         * =========================
         */
        $isCorrect = collect($request->answers)
            ->every(fn ($a) => $a['is_correct'] == 1);
        ...
        return response()->json([
            ...
            'attempts' => $attempt,
            'explanation' => $isCorrect
                ? 'Jawaban Anda sudah tepat.'
                : 'Masih ada jawaban yang salah, silakan coba kembali.'
        ]);
    }
}
